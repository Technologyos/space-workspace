package com.technologyos.role.exception;


import com.technologyos.role.common.StandardizedApiExceptionResponse;
 ...
 * 204-level (no content) — when the service return null
